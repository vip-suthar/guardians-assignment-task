  ...
  return (
    <div className="relative h-11 w-full min-w-[200px]">
      <input
        id={id}
        type={type}
        className="peer h-full w-full rounded-md border border-gray-200 border-t-transparent bg-transparent px-3 py-3 font-sans text-sm font-normal text-gray-700 outline outline-0 transition-all placeholder-shown:border placeholder-shown:border-gray-200 placeholder-shown:border-t-gray-200 focus:border-2 focus:border-indigo-500 focus:border-t-transparent focus:outline-0 disabled:border-0 disabled:bg-gray-50"
        name={name}
        value={value}
        placeholder=" "
